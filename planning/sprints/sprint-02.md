...
| `TASK-010` | Build chatbot/RAG (VMEC-04) — backend + tích hợp frontend | `drug-knowledge` | Nguyễn Minh Đạt + AI | **P0** | 🔄 In Progress (backend Done, xem ghi chú) | [`TASK-010`](../../tasks/TASK-010-build-chatbot.md) |
