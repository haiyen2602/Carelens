...
| 18 | **[ĐÃ CHỐT 2026-08-12 — vòng 3, mục 3.3]** Nội dung overlay category "ý định tự hại": **cảnh báo đây là hành động nguy hiểm + khuyên gặp bác sĩ ngay** — PM quyết định KHÔNG kèm số hotline khủng hoảng cụ thể (tránh rủi ro đưa sai số trong tình huống nhạy cảm). Vẫn giữ `# TODO [CẦN CHỐT]` marker trên hằng số mới (`SELF_HARM_OVERLAY_MESSAGE`) — đúng quy trình 2 người duyệt đã áp dụng cho 5 câu overlay gốc (PM + Phạm Thành Đạt), chỉ mới có xác nhận của PM, chưa có Phạm Thành Đạt. Không ảnh hưởng cơ chế escalate cho gia đình/bác sĩ (vẫn chạy như mọi redflag HIGH khác, mục 7). | Đã chốt nội dung (PM), chờ Phạm Thành Đạt duyệt thêm — giữ TODO marker |
...
| 23 | **[ĐÃ CHỐT 2026-08-12 — vòng 3, mục 9.3]** Phạm vi mở rộng mục 3.3 (thêm 5 câu giải thích ngắn/category, đi kèm 5 tiêu đề overlay đã có) — PM xác nhận đúng phạm vi, cùng quy trình duyệt PM + Phạm Thành Đạt như 5 tiêu đề gốc. Viết placeholder + `# TODO [CẦN CHỐT]` marker cho cả 5 câu, không chặn build — nội dung cụ thể chờ duyệt như #18. | Đã chốt phạm vi (PM), nội dung chờ duyệt — giữ TODO marker |
...
**Kết luận mục 3: core đã đóng, có bằng chứng thật, đã vá phần dao động biết được.** Việc còn treo: "Trung bình → escalate không khẩn" vẫn CHƯA wire (xem quyết định scope ở trên, `[CẦN CHỐT — Architect]` — đã tách rõ 4 câu hỏi cụ thể cần PM quyết trong lịch sử review 2026-08-12, không phải "cần quyết định ngưỡng" mơ hồ).
