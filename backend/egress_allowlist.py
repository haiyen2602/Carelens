...
truc scan import cua backend/, xem file do)."""

from __future__ import annotations

# Module trong backend/ duoc PHEP import truc tiep 1 HTTP client
...
# IMPORT TRUC TIEP httpx/requests/... trong code backend/ cua repo nay, khong
...
#      generate_answer) - qua backend/services/embeddings.py, backend/services/llm.py.
...
#      (backend/agents/tools/*.py, backend/services/retrieval.py) - KHONG co truy
#      van SQL dong tu input benh nhan o bat ky dau.
#   3. Escalate (gia dinh/bac si) - qua backend/services/escalation.py, ham
